...
TEST(PivxTransaction, LockScripts) {
    ...
    auto script3 = WRAP(TWBitcoinScript, TWBitcoinScriptBuildForAddress(STRING("6GFEoFg5VTHezgY2dKNRrqF4RxN9mywQ65").get()));
    ...
    auto script4 = WRAP(TWBitcoinScript, TWBitcoinScriptBuildForAddress(STRING("6MHC3zQH5H5pdz99FDC6SNJr5E8N9kb3k3").get()));
